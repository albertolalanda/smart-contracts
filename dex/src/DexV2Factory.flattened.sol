...
contract DexV2ERC20 is IDexV2ERC20 {
    string public constant override name = "Dex V2";
    string public constant override symbol = "DEX-V2";
...
contract DexV2Pair is IDexV2Pair, DexV2ERC20 {
    ...
    function _mintFee(uint112 _reserve0, uint112 _reserve1)
        ...
        returns (bool feeOn)
    {
        address feeTo = IDexV2Factory(factory).feeTo();
